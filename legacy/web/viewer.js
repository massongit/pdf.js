...
class PDFPageView {
  ...
  draw() {
    ...
    if (this.textLayer) {
      ...
      var _this$annotationLayer2, _this$annotationEdito3;
    ...
    if (!this.textLayer && this.textLayerMode !== _ui_utils.TextLayerMode.DISABLE && this.textLayerFactory) {
...
var _app = __webpack_require__(4);
var _document$blockUnbloc, _document;
const pdfjsVersion = '3.2.39';
const pdfjsBuild = '67e1c37e0';
const AppConstants = {
